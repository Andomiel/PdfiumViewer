...
namespace PdfiumViewer.Demo
{
    ...
    public abstract class TreeStrategyShellImageListProviderBase : TreeStrategyDataProviderBase, IDisposable
    {
        ...
        /// </summary>
        protected SystemImageList SystemImageList
        {
            get
            {
        ...
        protected virtual void SetIcon(TreeViewFolderBrowser treeView, TreeNodePath node)
        {
            ...
            //
            node.ImageIndex = this._systemImageList.IconIndex(node.Path, true, ShellIconStateConstants.ShellIconStateNormal);
            node.SelectedImageIndex = this._systemImageList.IconIndex(node.Path, true, ShellIconStateConstants.ShellIconStateOpen);
        }
        /// <summary>

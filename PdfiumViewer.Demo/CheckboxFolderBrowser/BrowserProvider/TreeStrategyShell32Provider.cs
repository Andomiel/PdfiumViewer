...
{
    /// <summary>
    /// <c>TreeStrategyFolderBrowserProvider</c> is the shell32 interop data provider for <see cref="TreeViewFolderBrowser"/> which is based on <see cref="ROOT.CIMV2.Win32.Logicaldisk"/>, <c>Shell32</c> Interop and <see cref="SystemImageList"/>
    ...
    public class TreeStrategyShell32Provider : TreeStrategyFolderBrowserProvider
    {
        ...
        private ShellBrowser _shell = new ShellBrowser();
        ...
        new public ShellAPI.CSIDL RootFolder { get; set; }
        ...
        public override void QueryContextMenuItems(TreeNodePath node)
        {
            ...
            //
            ShellItem fi = node.Tag as ShellItem;
            if (fi == null) return;
            ////
        ...
        public override void RequestChildNodes(TreeNodePath parent, System.Windows.Forms.TreeViewCancelEventArgs e)
        {
            ...
            if (!ShowFiles) return;
            //
            foreach (ShellItem fileItem in folderItem.SubFiles)
            {
        ...
        protected virtual TreeNodePath CreateTreeNode(System.Windows.Forms.TreeNodeCollection parentCollection, TreeNodePath parentNode, ShellItem shellItem)
        {
        ...
        protected virtual void FillMyComputer(ShellItem folderItem, System.Windows.Forms.TreeNodeCollection parentCollection, TreeViewFolderBrowserNodeFactory helper)
        {
            ...
            //
            foreach (ShellItem fi in folderItem.SubFolders)
            {
        ...
        /// </summary>
        protected virtual bool IsFolderWithChilds(ShellItem fi)
        {
